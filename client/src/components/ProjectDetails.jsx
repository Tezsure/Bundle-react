          ...
          <div className="container">
            <div className="row">
              <div className="col-md-5">
                ...
                <img  alt="daocardimage"  src="https://image.freepik.com/free-photo/beautiful-sunset-mountains-landscape-with-sun-light-shining-through-orange-clouds-fog_146671-18476.jpg"   style={{ width:'80%' }}  />
                  <br />
                  <br />
